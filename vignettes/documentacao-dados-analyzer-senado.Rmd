...
```{r message=FALSE}
id_pl_veneno_senado <- 41703
agoradigital::process_proposicao(id_pl_veneno_senado, 'senado')
```

Os dados retornados pela função **process_proposicao(id, "senado")**, além dos retornados pela [API Dados Abertos do Senado](https://www12.senado.leg.br/dados-abertos), estão distribuídos nas seguintes colunas:
