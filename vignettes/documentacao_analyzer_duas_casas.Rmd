...
O [Analyzer](../R/analyzers/analyzer.R) realiza operações de reconhecimento de eventos e fases em dataframes de tramitação da Câmara e do Senado.
...
tramitacao_senado <- process_proposicao(id_qualidade_fiscal_senado, 'senado')
tramitacao_senado
