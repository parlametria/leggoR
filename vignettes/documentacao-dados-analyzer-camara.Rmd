...
```{r message=FALSE}
prop_camara <- prop_camara <- agoradigital::fetch_proposicao(345311, 'camara')
tram_camara <- tramitacao_camara <- rcongresso::fetch_tramitacao(345311)
...
```{r}
library(readr)
readr::write_csv(tram_camara, "../data/tramitacao_345311.csv")
```
