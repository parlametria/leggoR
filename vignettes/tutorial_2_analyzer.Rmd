...
tram_camara <- agoradigital::fetch_tramitacao(id_qualidade_fiscal_camara, 'camara', T)
...
tram_senado <- agoradigital::fetch_tramitacao(id_qualidade_fiscal_senado, 'senado', T)

eventos_senado <- agoradigital::process_proposicao(prop_senado, tram_senado, 'senado')
eventos_senado %>% 
  select(data_hora, evento, local, casa, global)
```
