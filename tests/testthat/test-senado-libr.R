...
# Setup
setup <- function(){
  proposicao_data <<- fetch_proposicao(91341, 'senado')
  tramitacao_data <<- fetch_tramitacao(91341)
...
test <- function(){
  ...
  test_that("Regime de apreciacao", {expect_equal(extract_apreciacao_Senado(91341), APRECIACAO_91341)})
  test_that("Regime de tramitacao", {expect_equal(extract_regime_Senado(fetch_tramitacao(91341)), TRAMITACAO_91341)})
