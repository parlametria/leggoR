...
test <- function(){
  ...
  test_that('fetch_eventos_reqs_prop() returns dataframe', {
    expect_true(is.data.frame(fetch_eventos_reqs_prop(46249, 'camara')))
  })

  test_that('fetch_eventos_reqs_prop_camara() returns dataframe', {
    expect_true(is.data.frame(fetch_eventos_reqs_prop_camara(46249)))
  })
