...
pl_3729_2004_data_global <- frame_data(
  ...
  'Apresentação - Casa de Origem', 'Casa Origem', '2004-06-08', '2004-06-18','#d6952a',
  'Comissões - Casa de Origem', 'Casa Origem', '2004-06-22', '2007-01-30','#938ecc',
  'Comissões - Casa de Origem', 'Casa Origem', '2007-04-26', '2011-01-31','#938ecc',
  'Comissões - Casa de Origem', 'Casa Origem', '2011-02-14', '2015-01-31','#938ecc',
  'Comissões - Casa de Origem', 'Casa Origem', '2015-02-04', '2018-07-10','#938ecc')

pl_3729_2004_data_comissoes <- frame_data(
  ~ event, ~ group, ~ start, ~ end, ~ color,
  'CMADS', 'Comissões', '2004-06-22', '2014-01-06','#a6cee3',
  'CAPADR', 'Comissões', '2014-02-10', '2014-05-14','#b1b03a',
  'CMADS', 'Comissões', '2014-05-16', '2015-10-14','#a6cee3',
  'CFT', 'Comissões', '2015-10-20', '2018-07-10','#b2df8a',
  'CCJC', 'Comissões', '2016-05-09', '2018-07-10','#d6952a')

pl_3729_2004_data_comissao <- frame_data(
  ~ event, ~ group, ~ start, ~ end, ~ color,
  #CMADS
  'Receb.', 'Comissão', '2004-06-22', '2004-07-07','#96cee3',
  'Análise do Relator', 'Comissão', '2004-07-07', '2007-01-30','#a6cee3',
  'Receb.', 'Comissão', '2007-04-26', '2007-05-31','#96cee3',
  'Análise do Relator', 'Comissão', '2007-05-31', '2011-01-31','#a6cee3',
  'Receb.', 'Comissão', '2011-02-14', '2011-03-28','#96cee3',
  'Análise do Relator', 'Comissão', '2011-03-28', '2013-12-17','#a6cee3',

  #CAPADR
  'Receb.', 'Comissão', '2014-02-10', '2014-03-12','#b1b99a',
  'Análise do Relator', 'Comissão', '2014-03-12', '2014-04-29','#b1b03a',
  'Discussão e Votação', 'Comissão', '2014-04-29', '2014-05-14','#b1b50a',

  #CMADS
  'Receb.', 'Comissão', '2014-05-16', '2014-05-22','#96cee3',
  'Análise do Relator', 'Comissão', '2014-05-22', '2015-01-31','#a6cee3',
  'Receb.', 'Comissão', '2015-02-04', '2015-04-09','#96cee3',
  'Análise do Relator', 'Comissão', '2015-04-09', '2015-10-07','#a6cee3',
  'Discussão e Votação', 'Comissão', '2015-10-07', '2015-10-14','#a6ce93',

  #CTF
  'Receb.', 'Comissão', '2015-10-20', '2015-10-28','#92df8a',
  'Análise do Relator', 'Comissão', '2015-10-28', '2015-12-09','#b2df8a',
  'Receb.', 'Comissão', '2015-12-09', '2015-12-17','#92df8a',
  'Análise do Relator', 'Comissão', '2015-12-17', '2017-09-13','#b2df8a',
  'Receb.', 'Comissão', '2017-09-13', '2018-04-11','#92df8a',
  'Análise do Relator', 'Comissão', '2018-04-11', '2018-07-10','#b2df8a',

  #CCJC
  'Receb.', 'Comissão', '2016-05-09', '2016-05-11','#d6999a',
  'Análise do Relator', 'Comissão', '2016-05-11', '2016-05-23','#d6952a',
  'Receb.', 'Comissão', '2016-05-23', '2016-06-30','#d6999a',
  'Análise do Relator', 'Comissão', '2016-06-30', '2018-07-10','#d6952a')
...
pl_3729_2004_data_eventos <- frame_data(
  ...
  'Aprovado Parecer', 'Evento', '2015-10-14', '2015-10-14','#b1b03a',
