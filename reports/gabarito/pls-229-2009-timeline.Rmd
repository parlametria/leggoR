...
pl_229_2009_data_global <- frame_data(
  ~ event, ~ group, ~ start, ~ end, ~ color,
  'Apresentação - Origem (Senado)', 'Global', '2009-05-28', '2009-05-29', '#c8e6c9',
  'Comissões - Origem (Senado)', 'Global', '2009-05-29', '2016-05-17', '#fb8c00',
  ...
  'Comissões - Revisão (Câmara)', 'Global', '2016-06-28', '2017-06-07', '#2B488a'
  )

pl_229_2009_data_comissoes <- frame_data(
  ~ event, ~ group, ~ start, ~ end, ~ color,
  'CJC', 'Comissões', '2009-05-29', '2009-12-03', '#d6952a',
  'CAE', 'Comissões', '2009-12-03', '2010-05-19', '#f37340',
  ...
  'CFT', 'Comissões', '2016-06-28', '2016-11-18', '#A37340')
...
pl_229_2009_data_comissao <- frame_data(
  ...
  'Análise do Relator CJC', 'Comissão', '2009-07-15', '2009-09-22','#7ac974',
  'Receb. CJC', 'Comissão', '2009-09-23', '2009-09-24','#a6cee3',
  'Análise do Relator CJC', 'Comissão', '2009-09-24', '2009-11-13','#7ac974',
  'Discussão e Votação CJC', 'Comissão', '2009-11-13', '2009-12-03','#a561a2',

  # CAE
  'Receb. CAE', 'Comissão', '2009-12-03', '2009-12-04','#a6cee3',
  'Análise do Relator CAE', 'Comissão', '2009-12-04', '2010-05-19','#7ac974',
  ...
  'Discussão e Votação CAE', 'Comissão', '2010-12-21', '2011-01-20','#a561a2',
  ...
  # CFT
  'Receb. CFT', 'Comissão', '2016-06-28', '2016-07-06','#F6cee3',
  'Análise do Relator CFT', 'Comissão', '2016-07-06', '2016-11-18','#7ac974'
)
