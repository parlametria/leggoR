...
pl_3729_2004_data_casa_origem <- frame_data(
  ...
  'Apresentação - Origem (Senado)', 'Casa Origem', '2013-12-23', '2014-02-10','#c8e6c9',
  'Comissões- Origem (Senado)', 'Casa Origem', '2014-02-11', '2016-11-09','#fb8c00',
  'Plenário - Origem (Senado)',  'Casa Origem', '2016-11-09', '2017-02-03', '#214523')
