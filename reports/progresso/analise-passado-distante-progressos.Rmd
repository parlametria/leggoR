...
```
 ...
 Acho que é importante mostrar os pontos junto com o sumário nas visualizações. (Ex: nessa da mediana do tempo). ggbeeswarm talvez?


```{r}
library(ggbeeswarm)
 ggplot2::ggplot(progresso_data,aes(tema, semanas_decorridas, color = tema)) +
