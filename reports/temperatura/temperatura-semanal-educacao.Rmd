...
Na semana passada (06-10/05/2019), o tema Educação teve um acréscimo de temperatura de `r evolucao_temp_total_tema` unidades, indo de  `r temp_total_semana_passada_tema` para `r temp_total_semana_atual_tema`, como pode ser visto no gráfico abaixo `r ggplotly(plot_temperatura_tema)`.
