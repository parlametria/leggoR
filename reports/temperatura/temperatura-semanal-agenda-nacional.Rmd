...
plot_temperatura_agenda_nacional <- temperatura_semanas_destaque_tema %>% 
...
Na semana passada (06-10/05/2019), o tema Agenda Nacional teve um acréscimo de temperatura total de `r evolucao_temp_total_tema` unidades, indo de  `r temp_total_semana_passada_tema` para `r temp_total_semana_atual_tema`, como pode ser visto no gráfico abaixo. `r ggplotly(plot_temperatura_agenda_nacional)`
