...
temperatura_temas %>% 
  ...
  gghighlight(label_key = nome_pl)
```
Ao analisarmos os projetos de lei que mais contribuíram para o aumento da temperatura nesses picos observados, percebemos que a principal foi a PEC de Tornar o FUNDEB Permanente - **PEC 15/2015** e a **PLP 307/2002** que também trata sobre o FUNDEB
