...
Vamos analisar graficamente a evolução da temperatura por tema no ano de 2019 até o presente momento.
...
```{r}
semanas_destaque <- data.frame(semana = lubridate::ymd(c('2019-03-25','2019-04-01','2019-04-29','2019-05-06')
