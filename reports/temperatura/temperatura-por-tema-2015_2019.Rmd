...
O projeto de lei que mais contribuiu para o aumento da temperatura nesse pico observado foi a PEC 18/2011 (que autoriza o trabalho a partir dos 14 anos), responsável por `r round(100*(evolucao_semanal_temperatura_dh$evolucao_temp_recente[1]/sum(evolucao_semanal_temperatura_dh$evolucao_temp_recente)),2)`% do aumento na temperatura registrado naquela semana (iniciada em `r format(first(evolucao_semanal_temperatura_dh$semana), format="%d/%m/%Y")`) 
