...
library(ggplot2)
library(plotly)
semanas_destaque_tema <- data.frame(tema = "Direitos Humanos",
...
Na semana passada (06-10/05/2019), o tema Direitos Humanos teve queda de temperatura total de `r abs(evolucao_temp_total_tema)` unidades, indo de  `r temp_total_semana_passada_tema` para `r temp_total_semana_atual_tema`, como pode ser visto no gráfico abaixo. `r ggplotly(plot_temperatura_tema)`
