...
```{r, echo = FALSE, message=FALSE}
bill_data <- read_csv(paste0(base_dir,bill_id,'-bill-senado.csv'))
head(bill_data)
```
...
```{r, echo = FALSE, message=FALSE}
bill_passage_data <- read_csv(paste0(base_dir,bill_id,'-passage-senado.csv'))
...
```{r, echo = FALSE, message=FALSE}
bill_passage_summary_data <- read_csv(paste0(base_dir,bill_id,'-bill-passage-visualization-senado.csv'))
