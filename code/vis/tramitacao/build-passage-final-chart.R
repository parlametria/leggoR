...
pl_490_2007_data_estado <- frame_data(~ event, ~ group, ~ start, ~ end, ~ color, 
                               "Sob Analise", "Estado", "2007-03-20", "2011-01-30","#57d39b",  
                               "Arquivado", "Estado", "2011-01-31", "2011-02-15","#f37340",  
                               "Sob Analise", "Estado", "2011-02-16", "2015-01-30","#57d39b",  
                               "Arquivado", "Estado", "2015-01-31", "2015-02-09","#f37340",  
                               "Sob Analise", "Estado", "2015-02-10", "2018-06-12","#57d39b")
...
pl_490_2007_data_casa_origem <- frame_data(~ event, ~ group, ~ start, ~ end, ~ color, 
                                      ...
                                      "Comissões", "Casa", "2007-03-29", "2011-01-30","#b1b03a",
                                      "Comissões", "Casa", "2011-02-16", "2015-01-30","#b1b03a",
                                      "Comissões", "Casa", "2015-02-10", "2018-06-12","#b1b03a")
...
pl_490_2007_data_eventos <- frame_data(~ event, ~ group, ~ start, ~ end, ~ color, 
                                       ...
                                       "Parecer", "Evento", "2018-04-10", "2018-04-10","#ff6680",
                                       "Voto em separado", "Evento", "2018-05-22", "2018-05-22","#57d39b",
                                       "Retirado de pauta", "Evento", "2018-06-12", "2018-06-12","#aabc56")
