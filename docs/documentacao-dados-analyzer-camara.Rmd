...
Os dados retornados pela função **process_proposicao(<id>, "camara")**, além dos retornados pela [API Dados Abertos](https://dadosabertos.camara.leg.br/swagger/api.html), estão distribuídos nas seguintes colunas:
