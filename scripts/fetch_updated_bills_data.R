...
help <- "
Usage:
Rscript fetch_updated_bills_data.R <pls_ids_filepath> <export_path> <proposicoes_path>
"
...
readr::read_csv(pls_ids_filepath) %>%
	...
	agoradigital::export_data(export_path, proposicoes_path)
