...
if (casa == 'senado') {
  ...
  agoradigital::fetch_tramitacao_data(casa, paste0(export_path, "/tramitacoes"), senado_docs, dias_atras)
  ...
  if (nrow(new_docs_ids) > 0) {
    ...
    print("Buscando a tramitação dos documentos")
    agoradigital::fetch_tramitacao_data(paste0(export_path, "/tramitacoes"), updated_docs) 
